        ...
        <div class="product clear">
            <div id="content">
                ...
                <div class="post">
                    <h1 class="title">
                        <a
                                href="../novel/novel-information.jsp?id=<%=info.getId()%>"><%=info.getTitle() %>
                        </a>
                    </h1>
                    ...
                    <div class="person">
                        ...
                        <%--                            <a href="${pageContext.request.contextPath}/likeServlet?likeId=<%=info.getId()%>">--%>
                        <button type="button">

                            点赞
                        </button>
                        <a hidden="disabled"><%=info.getId()%>
                        </a>
                        <%--                            </a>--%>
                        <%--                        </form>--%>
